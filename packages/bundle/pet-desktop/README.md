...
Optional desktop pet bundle for DeepSeek Harness. Install it into the Web profile with `dsh plugin --profile web add @deepseek-ai/dsh-pet-desktop`, then use the UI or `/pet` to wake or tuck the companion.
