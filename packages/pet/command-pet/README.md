...
The command changes only the durable `awake` preference owned by `@luv1211/dsh-pet`. The desktop companion itself is supplied by `@luv1211/dsh-pet-desktop` in a desktop-capable DSH profile.
